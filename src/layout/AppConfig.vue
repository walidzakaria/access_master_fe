...
const isNotInvestigationPage = computed(() => route.path.indexOf('/investigation/') === -1);
  ...
  >
    ...
    <div class="grid">
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/bootstrap4-light-blue.svg"
            class="w-2rem h-2rem"
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/bootstrap4-light-purple.svg"
            class="w-2rem h-2rem"
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/bootstrap4-dark-blue.svg"
            class="w-2rem h-2rem"
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/bootstrap4-dark-purple.svg"
            class="w-2rem h-2rem"
    ...
    <div class="grid">
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/md-light-indigo.svg"
            class="w-2rem h-2rem"
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/md-light-deeppurple.svg"
            class="w-2rem h-2rem"
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/md-dark-indigo.svg"
            class="w-2rem h-2rem"
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/md-dark-deeppurple.svg"
            class="w-2rem h-2rem"
    ...
    <div class="grid">
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/tailwind-light.png"
            class="w-2rem h-2rem"
            alt="Tailwind Light"
          />
        </button>
    ...
    <div class="grid">
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/fluent-light.png"
            class="w-2rem h-2rem"
            alt="Fluent Light"
          />
        </button>
    ...
    <div class="grid">
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/lara-light-indigo.png"
            class="w-2rem h-2rem"
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/lara-light-blue.png"
            class="w-2rem h-2rem"
            alt="Lara Light Blue"
          />
        </button>
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/lara-light-purple.png"
            class="w-2rem h-2rem"
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/lara-light-teal.png"
            class="w-2rem h-2rem"
            alt="Lara Light Teal"
          />
        </button>
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/lara-dark-indigo.png"
            class="w-2rem h-2rem"
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/lara-dark-blue.png"
            class="w-2rem h-2rem"
            alt="Lara Dark Blue"
          />
        </button>
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/lara-dark-purple.png"
            class="w-2rem h-2rem"
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/lara-dark-teal.png"
            class="w-2rem h-2rem"
            alt="Lara Dark Teal"
          />
        </button>
    ...
    <div class="grid">
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/saga-blue.png"
            class="w-2rem h-2rem"
            alt="Saga Blue"
          />
        </button>
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/saga-green.png"
            class="w-2rem h-2rem"
            alt="Saga Green"
          />
        </button>
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/saga-orange.png"
            class="w-2rem h-2rem"
            alt="Saga Orange"
          />
        </button>
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/saga-purple.png"
            class="w-2rem h-2rem"
            alt="Saga Purple"
          />
        </button>
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/vela-blue.png"
            class="w-2rem h-2rem"
            alt="Vela Blue"
          />
        </button>
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/vela-green.png"
            class="w-2rem h-2rem"
            alt="Vela Green"
          />
        </button>
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/vela-orange.png"
            class="w-2rem h-2rem"
            alt="Vela Orange"
          />
        </button>
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/vela-purple.png"
            class="w-2rem h-2rem"
            alt="Vela Purple"
          />
        </button>
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/arya-blue.png"
            class="w-2rem h-2rem"
            alt="Arya Blue"
          />
        </button>
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/arya-green.png"
            class="w-2rem h-2rem"
            alt="Arya Green"
          />
        </button>
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/arya-orange.png"
            class="w-2rem h-2rem"
            alt="Arya Orange"
          />
        </button>
      ...
      <div class="col-3">
        ...
        >
          <img
            src="/static/images/themes/arya-purple.png"
            class="w-2rem h-2rem"
            alt="Arya Purple"
          />
        </button>
